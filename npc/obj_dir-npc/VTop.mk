...
VERILATOR_ROOT = /home/jihonglu/oss-cad-suite/share/verilator
...
VM_USER_CFLAGS = \
  -I../include -I../tools/capstone/repo/include -DSIM_MODE_NPC=1 -DTOP_CLASS=VTop \
...
cpu-exec.o: csrc/cpu-exec.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<
debugpoint.o: csrc/debugpoint.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<
